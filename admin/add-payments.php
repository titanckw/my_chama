...
$refno=$_POST['refno'];  
$status= 0;
$query=mysqli_query($con, "INSERT INTO payments(userid,amount,pay_date,balance,pay_type,refno,status) VALUES('$userid','$amount',now(),'$balance','$pay_type','$refno','$status')");
...
<option value="Savings">Contributions</option>
